...
public sealed record PingCommand(string Id) : global::MediatR.IRequest
{
	public static PingCommand Instance { get; } = new("test-123");
}

// Scenario 2: Query with return value for InvokeAsync<T>
public sealed record GetOrder(int Id) : global::MediatR.IRequest<Order>
{
	public static GetOrder Instance { get; } = new(42);
}

// Scenario 3: Notification for PublishAsync with multiple handlers
public sealed record UserRegisteredEvent(string UserId, string Email) : global::MediatR.INotification
{
...
public record GetFullQuery(int Id) : global::MediatR.IRequest<Order>
{
...
public sealed record CreateOrder(int CustomerId, decimal Amount) : global::MediatR.IRequest<Order>
{
	public static CreateOrder Instance { get; } = new(123, 99.99m);
}

public sealed record OrderCreatedEvent(int OrderId, int CustomerId) : global::MediatR.INotification;
...
public record GetCachedOrder(int Id) : global::MediatR.IRequest<Order>
{
